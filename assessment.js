...
(function(){
    'use strict'
    const userNameInput = document.getElementById('userForm');
    ...
    assessmentButton.onclick = ()=> {
        ...
        const res = assessment(userNameInput.value);
        paragraph.textContent = res;
        resultDivided.appendChild(paragraph);

        removeAllChildren(tweetDivided);
        const anchor = document.createElement('a');
        const hrefValue = 'https://twitter.com/intent/tweet?button_hashtag=test&text=' + encodeURIComponent(res);
        anchor.setAttribute('href',hrefValue);
        anchor.className = 'twitter-hashtag-button';
        anchor.textContent = 'Tweet #test';
